  ...
  visualizations: [
    {
      ...
      layers: ["proof"],
      nodes: [
        { id: "s0", type: "Term", layer: "proof", label: "$S(S(0))+S(S(0))$", position: { x: 40, y: 20 } },
        { id: "s1", type: "Term", layer: "proof", label: "$S\\big(S(S(0))+S(0)\\big)$", position: { x: 40, y: 130 } },
        { id: "s2", type: "Term", layer: "proof", label: "$S\\big(S(S(S(0))+0)\\big)$", position: { x: 40, y: 240 } },
        { id: "s3", type: "Term", layer: "proof", label: "$S(S(S(S(0))))$", position: { x: 40, y: 350 } },
        { id: "s4", type: "Term", layer: "proof", label: "$4$", position: { x: 40, y: 450 } },
      ],
      edges: [
        ...
        { id: "e4", source: "s3", target: "s4", type: "relates", label: "abbreviation: 4 := S(S(S(S(0))))", layer: "proof" },
      ],
    },
  ],
  confusions: [
